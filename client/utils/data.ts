import { DocumenTypes } from './enums'

export const documentTypes = {
  [DocumenTypes.DECLARANT]: 'Необходимые документь',
  [DocumenTypes.INCOMING]: 'Входящие документь',
  [DocumenTypes.DECORATED]: 'Документь офорленные',
  [DocumenTypes.SERVICE]: 'Услуги',
}
